...
def create_server_app(
    ...
    async def update_config(req: AppConfigRequest) -> dict:
        ...
        if req.gitlab_url and req.gitlab_token:
            ...
            _source_registry.unregister_vcs("gitlab")
        ...
        if req.github_token:
            ...
            _source_registry.unregister_vcs("github")
        ...
        try:
            async with httpx.AsyncClient(timeout=10) as client:
                ...
                if resp.status_code != 200:
                    ...
                    return {"error": f"GitHub respondió {resp.status_code}"}
                data = resp.json()
                return {
    ...
    @app.post("/github/oauth/poll")
    async def github_oauth_poll(body: dict = Body(...)) -> dict:
        ...
        try:
            async with httpx.AsyncClient(timeout=10) as client:
                ...
                if "access_token" in data:
                    ...
                    _app_config["github_token"] = token
                    from .sources.github import GitHubSource
