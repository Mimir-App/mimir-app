...
<template>
  <div class="tab-content">
    ...
    >
      ...
      <template #details>
        <SettingRow label="Servidor">
          <span>{{ configStore.config.odoo_url }}</span>
        </SettingRow>
        <SettingRow label="Version">
          <span>{{ configStore.config.odoo_version }}</span>
        </SettingRow>
        <SettingRow label="Usuario">
          <span>{{ configStore.config.odoo_username }}</span>
        </SettingRow>
